        ...
        <div class="right">
            ...
            <div class="providerAdd">
                <form action="roleAdd" method="post">
                    ...
                    <div>
                        <label for="roleName">角色编号：</label>
                        <input type="text" name="ucode" id="roleDec" />
                        <span>*请输入角色编号</span>
                    </div>
                    <div class="privilege">
                        <label for="roleName">角色权限：</label>
                        <input type="radio" name="rid" value="1" checked/>超级管理员
                        <input type="radio" name="rid" value="2" >普通管理员
