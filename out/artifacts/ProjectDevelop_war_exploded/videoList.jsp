        ...
        <div class="right">
            ...
            <table class="providerTable" cellpadding="0" cellspacing="0">
                ...
                <c:forEach var="video" items="${videos}">
                    <tr>
                        <td>${video.vid}</td>
                        <td><a href="videoDownload?filename=${video.vurl}&vid=${video.vid}">${video.vname}</a></td>
                        <td>${video.vsize}</td>
                        <td>${video.vtype}</td>
                        ...
                        <td>
                            <c:if test="${user_details}">
                                <a href="videoDetails?vid=${video.vid}" target="_blank"><img src="img/read.png" alt="查看" title="查看"/></a>
                            </c:if>
                            <c:if test="${user_edit}">
                                <a href="videoUpdate?vid=${video.vid}"><img src="img/xiugai.png" alt="编辑" title="编辑"/></a>
                            </c:if>
                            <c:if test="${user_delete}">
                                <a href="videoDelete?vid=${video.vid}" class="delete"><img src="img/schu.png" alt="删除" title="删除"/></a>
                            </c:if>
                        </td>
                    </tr>
                </c:forEach>
